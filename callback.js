...
const plusNums = arr => {
  ...
  const divideN = n=>n/2;
  const plusN = n=>n+10;
  const powN = n=>n**2;//vozvesti v stepeni
...
// (instruction- eto callback functiea mi ee peredali toesti eto povN,plusN,multN)
// changeNums- eto  High-order function (функция высшего порядка)
